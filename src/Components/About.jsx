          ...
          <div className="pt-6">
            <div className="space-x-6 flex justify-center">
              <a href={Links.instagram} >
                <FontAwesomeIcon
                  className="cursor-pointer  hover:text-yellow-500 transition delay-75 duration-200 ease-in-out hover:bg-black sm:text-2xl text-xl rounded-full bg-yellow-400 p-[1rem] sm:p-[1rem]"
                  icon={faInstagram}
                />
              </a>
