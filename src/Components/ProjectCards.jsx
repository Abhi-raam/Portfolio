...
function ProjectCards({ project }) {
    ...
    return (
        <div className="group card card-side hover:shadow-2xl overflow-hidden cursor-pointer sm:h-[20rem] bg-slate-300 w-auto md:w-[40rem] justify-self-center shadow-xl">
