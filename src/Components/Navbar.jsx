        ...
        <div className='fixed top-0 left-0 right-0 z-50'>
            <div className="navbar  bg-white-10/2 bg:blur bg-opacity-30 backdrop-blur">
                <div className="flex-1 text-white">
                    <p className="btn btn-ghost normal-case text-xl md:text-2xl">Abhiram</p>
                </div>
                <div>
                    <ul className="lg:flex items-center space-x-6  font-semibold">
                        <li className='lg:inline-block hidden cursor-pointer hover:text-slate-700 text-white transition delay-75 duration-150 ease-in-out'>
                ...
                <div className="relative">
                    <div className='grid backdrop-filter backdrop-blur bg-opacity-30  bg-white-10/2 justify-end font-semibold absolute top-0 left-0 right-0'>
                        <ul className="mr-3 space-y-2" >
                            <li className='hover:text-slate-700 text-white transition delay-75 duration-150 ease-in-out'>
                                <Link to="home" smooth={true} duration={500}>Home</Link>
                            </li>
                            <li className='hover:text-slate-700 text-white transition delay-75 duration-150 ease-in-out'>
                                <Link to="about" smooth={true} duration={500}>About Me</Link>
